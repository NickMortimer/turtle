...
CCDSIZE =0.0132/5472
class Mavic2:
    def __init__(self,crs,imagewidth=5472,imageheight=3648,pixelsize=CCDSIZE):
        self.imagewidth =imagewidth
        self.imageheight = imageheight
        self.pixelsize = pixelsize
        self.focalmm = 10.3
        self.sensorwidth = 13.2
        self.focalpixel = (self.focalmm / self.sensorwidth) * self.imagewidth
        self.crs = crs
        #Km K matrix in mm.
        self.Km = np.array([[self.focalmm/1000,0,(self.imagewidth/2)*self.pixelsize,0],
                        [0,self.focalmm/1000,(self.imageheight/2)*self.pixelsize,0],
                        [0,0,1,0]])
